...
const LoginForm: React.FC = () => {
  return (
    <form className="flex relative flex-col self-center px-16 pt-10 pb-28 h-[80%] mt-10 max-w-full text-lg bg-white rounded-3xl shadow-sm text-neutral-700 w-[80%] ml-[10%] max-md:px-5 max-md:pb-24 max-md:mt-10">
